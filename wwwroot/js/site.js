                ...
                (o.prototype.reveal = function (t, e, n, i) {
                    ...
                    for (var y = 0; y < u.length; y++)
                        (g = u[y].getAttribute("data-sr-id")),
                            ...
                            l(p),
                            f(p),
                            (N.tools.isMobile() && !p.config.mobile) ||
                            !N.isSupported()
                ...
                (e.VERSION = "3.3.7"),
                    ...
                    (e.prototype.process = function () {
                        ...
                        if ((this.scrollHeight != n && this.refresh(), e >= i))
                            return (
                                r != (t = s[s.length - 1]) && this.activate(t)
                            );
                        if (r && e < o[0])
        ...
        !(function (e, n) {
            ...
            function L(t, e, n, i) {
                ...
                if (
                    ...
                    for (
                        a = yt.map(T(o, "script"), $), c = a.length;
                        p < f;
                        p++
                    )
                        (l = o),
                    ...
                    if ((i = Q.prefilters[s].call(l, t, u, l.opts)))
                        return (
                            yt.isFunction(i.stop) &&
                                (yt._queueHooks(l.elem, l.opts.queue).stop =
                                    yt.proxy(i.stop, i)),
                            i
                        );
                return (
                    ...
                    yt.fx.timer(
                        yt.extend(c, { elem: t, anim: l, queue: l.opts.queue })
                    ),
                    l
                );
            }
            ...
            function it(t, e, n) {
                for (
                    var i, o, s, r, a = t.contents, c = t.dataTypes;
                    "*" === c[0];
            ...
            var Ct = (function (t) {
                        ...
                        if (11 !== h && (c = gt.exec(t)))
                            if ((o = c[1])) {
                                ...
                                if (
                                    ...
                                    return (
                                        Q.apply(n, e.getElementsByClassName(o)),
                                        n
                                    );
                            }
                ...
                function c(t) {
                    return i(function (e) {
                        return (
                            ...
                            i(function (n, i) {
                                for (
                                    var o, s = t([], n.length, e), r = s.length;
                                    r--;
                ...
                function g(t, e, n, i, o) {
                    for (
                        var s, r = [], a = 0, c = t.length, l = null != e;
                        a < c;
                        a++
                    )
                        (s = t[a]) &&
                            ((n && !n(s, i, o)) || (r.push(s), l && e.push(a)));
                    return r;
                }
            ...
            (yt.event = {
                ...
                handlers: function (t, e) {
                    ...
                    return (
                        (l = this),
                        c < e.length &&
                            a.push({ elem: l, handlers: e.slice(c) }),
                        a
                    );
                },
                    ...
                    ajax: function (t, e) {
                        function i(t, e, i, a) {
                            ...
                            u ||
                                ...
                                (C.statusText = (e || T) + ""),
                                l
                                    ? m.resolveWith(g, [f, T, C])
                                    : m.rejectWith(g, [C, T, d]),
                                C.statusCode(b),
                                (b = void 0),
                                p &&
                    ...
                    if (a || "jsonp" === t.dataTypes[0])
                        return (
                            ...
                            (t.converters["script json"] = function () {
                                return (
                                    r || yt.error(o + " was not called"), r[0]
                                );
                            }),
                            (t.dataTypes[0] = "json"),
                            (s = n[o]),
                    ...
                    return (
                        e ||
                            (mt.createHTMLDocument
                                ? ((e =
                                      rt.implementation.createHTMLDocument("")),
